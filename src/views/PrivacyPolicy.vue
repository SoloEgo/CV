...
<template>
    <div class="portfolio">
        ...
        <ul>
            ...
            <li>
                <p><strong>Application</strong> refers to Toddler Time, the software program provided by the Company.</p>
            </li>
            <li>
                <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot;
                    or &quot;Our&quot; in this Agreement) refers to Toddler Time.</p>
            </li>
            <li>
        ...
        <ul>
            <li>By email: egorsoloviev.web@gmail.com</li>
        </ul>
    </div>
</template>
  
<style>
.header-content, header, .console_row{
